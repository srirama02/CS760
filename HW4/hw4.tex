...
\begin{enumerate}
    ...
    \begin{soln}
        Used implementation from 4.3 and the same hyperparameters.\\
        a.\\
        Test Errors:\\
        The test error is $0.65$\\

        Learning Curve:\\
        \begin{figure}[h!]
            \centering
            \includegraphics[width=0.4\textwidth]{4.3.a.png}  
        \end{figure}
        \FloatBarrier

        b.\\
        Test Errors:\\
        The test error is $0.90$\\
        Learning Curve:\\
        \begin{figure}[h!]
            \centering
            \includegraphics[width=0.4\textwidth]{4.3.b.png}  
        \end{figure}
        \FloatBarrier
    \end{soln}
\end{enumerate}
